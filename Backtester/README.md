...
| Namespace | Contents |
|---|---|
| `Backtester.Core` | `Candle`, `Order`, `Trade`, `Position`, `Portfolio`, `Instrument`, `ConversionOperation`, `CurrencyConverter`, `PortfolioSnapshot`, `PerformanceStats`, `MarketSlice`, `Indicator`, `IndicatorSeries`, `IndicatorShape`, `IndicatorPoint`, `IndicatorPane` |
